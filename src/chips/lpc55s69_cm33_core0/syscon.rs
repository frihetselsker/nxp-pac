...
impl Syscon {
    ...
    pub const fn fcckkselx(
        self,
        n: usize,
    ) -> crate::common::Reg<regs::Fcclkselx0, crate::common::RW> {
        assert!(n < 8usize);
        unsafe {
    ...
    pub const fn fcclksel(
        self,
        n: usize,
    ) -> crate::common::Reg<regs::Fcclksel0, crate::common::RW> {
        assert!(n < 8usize);
        unsafe {
            crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x02b0usize + n * 4usize) as _)
        }
    ...
    pub const fn flexfrgctrl(
        self,
        n: usize,
    ) -> crate::common::Reg<regs::Flexfrg0ctrl, crate::common::RW> {
        assert!(n < 8usize);
        unsafe {
    ...
    pub const fn flexfrgxctrl(
        self,
        n: usize,
    ) -> crate::common::Reg<regs::Flexfrgxctrl0, crate::common::RW> {
        assert!(n < 8usize);
        unsafe {
            crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x0320usize + n * 4usize) as _)
        }
