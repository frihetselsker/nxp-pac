...
impl Gpio {
    ...
    pub const fn mpin(self, n: usize) -> crate::common::Reg<regs::Mpin, crate::common::RW> {
        assert!(n < 2usize);
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(0x2180usize + n * 4usize) as _) }
    }
